...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    div.mb-4
      h3 Contexto interno de la empresa
    ...
    div.mb-5
      h3.mb-4 Contexto externo de la empresa
    .row.mb-5
    ...
    .row.mb-5
      ...
      .col-12.col-md-4.col-lg-4.p-4.cont2bgr
        ...
        .row.mb-3
          .col-12.col-md-12.col-lg-12.mt-4.mb-4
            figure.justify-center
              img.img250(src='@/assets/curso/tema1/t1-14.svg')
        ...
        .row(titulo="Procesos").justify-center.m-0
          ...
          .col-12.col-md-8.col-lg-8.align-items-center
            ...
            p Involucrar a personal clave en los diferentes 
              ...
              | permite contar con diferentes puntos de vista y aspectos críticos que el sistema de gestión pueda pasar por alto (personal diferente a la dirección y líderes del proceso).
 
        .row(titulo="Metodología").justify-center
        ...
        .row(titulo="Partes interesadas").justify-center
          ...
          .col-12.col-md-8.col-lg-8.align-items-center
            ...
            p Identificar las 
              ...
              | desde el contexto interno y externo, con el fin de identificar a quienes perciben o dejan de percibir el impacto positivo o negativo de la empresa. Entre ellos encontramos: clientes, colaboradores, proveedores, vecinos, entidades gubernamentales, etc. 
          

        .row(titulo="Evaluación y calificación").justify-center
          .col-12.col-md-4.col-lg-4.align-items-center
            figure.justify-center
        ...
        .row(titulo="Estrategias").justify-center
          ...
          .col-12.col-md-8.col-lg-8.align-items-center
            ...
            p Definir 
              ...
              | de acuerdo a los resultados del análisis del contexto y para esto se debe realizar una planificación de las estrategias con el objetivo de explotar las oportunidades y reducir los riesgos. 
 
        .row(titulo="Revisión y ajustes").justify-center
          .col-12.col-md-4.col-lg-4.align-items-center
            figure.justify-center
        ...
        .tarjeta.tarjeta-flip.color-primario(@mouseover="indicadorTarjetaFlip = false")
          ...
          .tarjeta-flip__contenedor
            .tarjeta-flip__img(:style="{'background-image': `url(${require('@/assets/curso/tema1/t1-24.png')})`}").align-items-end
              figure
                img(src='@/assets/curso/tema1/t1-24-1.svg')
        ...
        .tarjeta.tarjeta-flip.color-primario(@mouseover="indicadorTarjetaFlip = false")
          ...
          .tarjeta-flip__contenedor
            .tarjeta-flip__img(:style="{'background-image': `url(${require('@/assets/curso//tema1/t1-25.png')})`}").align-items-end
              figure
                img(src='@/assets/curso/tema1/t1-25-1.svg')
          ...
          li
            ul
              li 
                ...
                | Garantía de igualdad para todo el personal de trabajo, todos deben tener los mismos derechos al ser contratados sin importar su etnia, género, ideología u orientación sexual. 
              li 
                i.fas.fa-angle-right.colori
                | Tener en cuenta aquellas personas con mayor experiencia dentro de la empresa a la hora de acceder a puestos superiores o a una vacante, pero siempre que cumplan las cualidades requeridas.
              li 
                i.fas.fa-angle-right.colori
        ...
        ul.lista-ul.p-3
          li
            ul
              li 
                i.fas.fa-angle-right.colori
                | Evitar la subcontratación en cualquier área de la empresa. 
              li 
                i.fas.fa-angle-right.colori
                | Asignar un sueldo o remuneración acorde con las funciones que debe desempeñar el trabajador. 
              li 
                i.fas.fa-angle-right.colori
                | Difusión del reclutamiento a través de diferentes medios (bolsas de empleo, redes sociales, etc.). 
              li 
                i.fas.fa-angle-right.colori
                | Motivación del personal, capacitaciones y ejercicios antiestrés. 
...
export default {
  ...
  data: () => ({
    datosLineaTiempoB: [
      {
        titulo: 'Datos generales del cargo',
        icono: require('@/assets/curso/tema1/ico1.svg'),
      },
      {
        titulo: 'Justificación',
        icono: require('@/assets/curso/tema1/ico2.svg'),
      },
      {
        titulo: 'Candidato ideal',
        icono: require('@/assets/curso/tema1/ico3.svg'),
      },
      {
        titulo: 'Responsabilidades',
        icono: require('@/assets/curso/tema1/ico4.svg'),
      },
      {
        titulo: 'Requisitos',
        icono: require('@/assets/curso/tema1/ico5.svg'),
      },
      {
        titulo: 'Competencias',
        icono: require('@/assets/curso/tema1/ico6.svg'),
      },
      {
        titulo: 'Habilidades o destrezas',
        icono: require('@/assets/curso/tema1/ico7.svg'),
      },
      {
        titulo: 'Experiencia',
        icono: require('@/assets/curso/tema1/ico8.svg'),
      },
      {
        titulo: 'Formación',
        icono: require('@/assets/curso/tema1/ico9.svg'),
      },
      {
        titulo: 'Estructura',
        icono: require('@/assets/curso/tema1/ico10.svg'),
      },
    ],
  }),
  mounted() {
