  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    .row.mb-5
      .col-12.col-md-7.col-lg-7
        p Las empresas de hoy en día deben apostar al bienestar y la personalización al momento de implementar un proceso de selección de talento humano, su objetivo es encontrar y tener en sus empresas más personas felices que disfruten de su trabajo. Varios estudios sobre organizaciones saludables y resilientes concluyen que las personas con mayor felicidad tienen más seguridad, se ven socialmente más atractivas y trabajan de forma cooperativa o en equipo. 
    ...
    .row.mb-5
      .col-md-6.mb-5.mb-md-0
        ...
        LineaTiempoD.color-acento-contenido
          p.text-small(numero="1" titulo="Comunicar y compartir") Son plataformas para el intercambio de información u opinión. Según su tipo permite compartir imágenes, videos, documentos, opiniones e información.
          
          p.text-small(numero="2" titulo="Crear o mantener contacto") Las redes permiten crear un usuario en la red, conectarse y comunicarse con otros sin importar el lugar o tiempo (amigos, familia, parejas, relaciones laborales, etc.). 
          
          p.text-small(numero="3" titulo="Informarse") Las redes sociales manejan una gran cantidad de información que permite a los usuarios mantenerse informados sobre acontecimientos importantes o temáticas de interés. 
          
          p.text-small(numero="4" titulo="Entretenerse") Permiten crear comunidades con intereses similares. Convirtiéndose en una gran fuente de entretenimiento y distensión.

          p.text-small(numero="5" titulo="Vender/comprar") Algunas redes sociales se han establecido como canales para la compra y venta de bienes o servicios. Aquí se pueden encontrar plataformas como Instagram o Facebook, donde el usuario puede seguir los negocios y establecer con ellos actuaciones comerciales.
    ...
    .row.mb-2
      .col-md-3.col-xl.mb-4.mb-xl-0
        .tarjeta-numerada.color-acento-contenido.p-5
          ...
          p.text-center 
            b Son inmediatas
          p.text-center Estas funcionan en tiempo real. La información, los videos, las imágenes y las opiniones que se comparten en las redes suelen hacerse públicas y estar al alcance de cualquier persona en el mundo. 
      .col-md-3.col-xl.mb-4.mb-xl-0
        .tarjeta-numerada.color-primario.p-5
          ...
          p.text-center 
            b Son masivas
          p.text-center Las redes sociales involucran a una gran porción de la población y han logrado eliminar las barreras culturales y etarias.
      .col-md-3.col-xl.mb-4.mb-xl-0
        .tarjeta-numerada.color-acento-contenido.p-5
          .tarjeta-numerada__numero
            .h2 3
          p.text-center 
            b Acortan distancias
          p.text-center Permiten la comunicación con amigos, familiares y cualquier usuario de la red, sin importar la distancia geográfica.
      .col-md-3.col-xl.mb-4.mb-xl-0
        .tarjeta-numerada.color-primario.p-5
          .tarjeta-numerada__numero
            .h2 4
          p.text-center 
            b Aumentan la visibilidad de las marcas
      ...
      .col-12.col-md-3.col-lg-3.mb-4
        .tarjeta-numerada.color-acento-contenido.p-5
          .tarjeta-numerada__numero
            .h2 7
          p.text-center 
            b Brindan oportunidades laborales
          p.text-center Hay empresas que utilizan las redes sociales para dar a conocer su oferta y a su vez estas permiten conocer el perfil laboral de los usuarios. Entre estas redes se encuentra LinkedIn, se crearon con el objetivo específico de formar comunidades de profesionales. 
    
    div.mb-5
      h3 Tipos de redes sociales
      p Las redes sociales por lo general se dividen en diferentes tipos, algunas de ellas pueden ser de más de un tipo. Entre sus clasificaciones más comunes están: 
    ...
    .row.mb-5
      .col-md-6.mb-5.mb-md-0
        ...
        LineaTiempoD.color-acento-contenido
          ...
          p.text-small(numero="4" titulo="Red social de nicho. ") Son aquellas dirigidas a un público específico, ya sea una categoría profesional o personas que tienen un interés específico en común. Aquí se encuentran App de lecturas, comunidades de artistas, gastronomía, etc. 
    ...
    SlyderA.cont12bgr
      ...
      .row
        ...
        .col-12.p-4.col-md-5.mb-4.mb-md-0.mt-5
          h3 LinkedIn
          p Es la mayor red social corporativa del mundo. Su objetivo está enmarcado en contactos profesionales. Donde se generan conexiones entre empresas y profesionales que buscan una experiencia laboral. Se utiliza para el reclutamiento de profesionales, intercambio de experiencias y otras actividades corporativas. 
      ...
      .row
        ...
        .col-12.p-4.col-md-5.mb-4.mb-md-0.mt-5
          h3 WhatsApp
          p Es una red social de mensajería instantánea. Permite la publicación de estados y lo último que se creó a la par fue WhatsApp empresarial que permite un manejo adecuado y rápido de la información y notificación de la empresa. 
      ...
      .row
        ...
        .col-12.p-4.col-md-5.mb-4.mb-md-0.mt-5
          h3 YouTube
          p Es la principal red social de videos online de la actualidad, con más de 1.000 millones de usuarios activos y más de 500 millones de vídeos visualizados diariamente.
    ...
    div.mb-5
      ...
      p Los componentes del sistema de información permiten una serie de procesos que consisten en:
    
    TabsA.color-acento-botones.mb-5
      .tarjeta.color-acento-botones--borde.p-4(titulo="La entrada de la información")
        .row
          .col-12.col-md-7.col-lg-7
          ...
          .col-12.col-md-5.col-lg-5
            figure.justify-center
              img.img250(src='@/assets/curso/tema3/t3-15.svg', alt='Imagen 3-15')

      .tarjeta.color-acento-botones--borde.p-4(titulo="El procesamiento de la información registrada")
        .row
          .col-12.col-md-7.col-lg-7.mt-5
            h4 El procesamiento de la información registrada
            p El sistema permite una serie de operaciones y acciones que se establecen y configuran previamente. Después de ingresar la información se transforma en datos de información que permitirán tomar decisiones, valoración, análisis e investigación con el objetivo de generar un balance del proceso.  
      
          .col-12.col-md-5.col-lg-5
            figure.justify-center
              img.img250(src='@/assets/curso/tema3/t3-16.svg', alt='Imagen 3-16')

      .tarjeta.color-acento-botones--borde.p-4(titulo="El almacenamiento de la información")
        .row
          .col-12.col-md-7.col-lg-7.mt-5
          ...
          .col-12.col-md-5.col-lg-5
            figure.justify-center
              img.img250(src='@/assets/curso/tema3/t3-17.svg', alt='Imagen 3-17')

      .tarjeta.color-acento-botones--borde.p-4(titulo="La salida de la información")
        .row
          .col-12.col-md-7.col-lg-7.mt-5
            h4 La salida de la información
            p La información suministrada y previamente procesada, permitirá al usuario su fácil análisis y acceso, y puede sacar la información a través de diferentes dispositivos como: USB, impresoras, sistemas de voz, discos duros portátiles, entre otros.
    ...
    div.mb-5
      h3 Elementos de un sistema de información
      p Se pueden categorizar los sistemas de información en diversos elementos: 
    ...
    .row.mb-5
      ...
      .col-12.col-md-4.col-lg-4.mt-4
        p Cada una de estas plataformas cuentan con funciones diferentes que facilitan a los usuarios resolver distintos tipos de problemas de manera automatizada, mediante el uso de menos recursos. A continuación, se mencionan algunos tipos de plataformas más comunes:

    SlyderA.cont15bgr.mb-5
      .row
        .col-md-1
        .col-12.p-4.col-md-5.mb-4.mb-md-0.mt-5
      ...
      .row
        .col-md-1
        .col-12.p-4.col-md-5.mb-4.mb-md-0.mt-5
          h3 Plataformas sociales 
          p Son conocidas también como redes sociales, son aquellas donde se guardan diversas informaciones relacionadas con las interacciones sociales. Estas permiten la comunicación e interacción de los usuarios con familiares, amigos o conocidos a través de Internet. Entre estas se encuentran Facebook, LinkedIn, Instagram y Twitter como ejemplos de plataformas sociales. 
    ...
    div.mb-5
      ...
      p Hoy en día existen diferentes sistemas de almacenamiento en la nube gratuitos que brindan la posibilidad para que los usuarios puedan almacenar archivos de manera segura, y acceder a ellos en cualquier momento desde sus computadores y dispositivos móviles, su objetivo es no ocupar espacio en sus dispositivos y que por medio de sus mismos dispositivos u otros puedan acceder a la información. 
      p Entre las aplicaciones o plataformas de almacenamiento más populares están las siguientes:
    ...
    .row.mb-5
      ...
      .col-md-6.mb-5.mb-md-0
        figure.justify-center
          img.img300(src='@/assets/curso/tema3/t3-50.svg')
    ...
    TabsA.color-acento-botones.mb-5
      .tarjeta.color-acento-botones--borde.p-4(titulo=" Facilidad de acceso")
        .row
          .col-12.col-md-7.col-lg-7.mt-5
            ...
            p Se necesita un usuario, clave y conexión a Internet para acceder a sus archivos desde cualquier dispositivo o lugar.
      ...
      .tarjeta.color-acento-botones--borde.p-4(titulo="Fáciles de usar")
        .row
          .col-12.col-md-7.col-lg-7.mt-5
            h4 Fáciles de usar
            p Su diseño permite que cualquier persona pueda utilizarlos y de forma automática realiza copias de seguridad. 
      ...
      .tarjeta.color-acento-botones--borde.p-4(titulo="Menor riesgo de desaparecer")
        .row
          .col-12.col-md-7.col-lg-7.mt-5
            ...
            p Los archivos en la nube disponen de réplicas o copias de los datos.
      ...
      .tarjeta.color-acento-botones--borde.p-4(titulo="Menor riesgo de desaparecer")
        .row
          .col-12.col-md-7.col-lg-7.mt-5
            ...
            p Existen usuarios de categoría premium y gratuitos, los primeros pagan por recibir más opciones o capacidad de almacenamiento y son los que sustentan los costos asociados a estas plataformas, como mantenimiento de los servidores y consumo eléctrico.
      
          .col-12.col-md-5.col-lg-5
            figure.justify-center
              img.img250(src='@/assets/curso/tema3/t3-55.svg', alt='Imagen 3-55')
